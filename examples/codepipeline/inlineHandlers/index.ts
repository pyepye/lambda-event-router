...
import { deployActionRoute } from './handlers/deployActionRoute.js';
import { processArtifactsRoute } from './handlers/processArtifactsRoute.js';

const codePipelineRouter = createCodePipelineRouter();

codePipelineRouter.route(processArtifactsRoute).route(continuationRoute).route(deployActionRoute);
