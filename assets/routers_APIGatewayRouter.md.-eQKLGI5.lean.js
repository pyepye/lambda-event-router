import{C as i,o as n,c as d,a6 as e,E as h}from"./chunks/framework.DlxdiH7Q.js";const k=JSON.parse('{"title":"APIGatewayRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/APIGatewayRouter.md","filePath":"routers/APIGatewayRouter.md"}'),r={name:"routers/APIGatewayRouter.md"},c=Object.assign(r,{setup(o){const t=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type ListOrdersQuery = z.infer<typeof ListOrdersQuerySchema>`}];return(p,s)=>{const a=i("CodeFileViewer");return n(),d("div",null,[s[0]||(s[0]=e("",161)),h(a,{files:t,id:"apigateway-example","default-file":"api.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",3))])}}});export{k as __pageData,c as default};
