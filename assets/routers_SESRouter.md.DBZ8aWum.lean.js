import{C as t,o as n,c as h,ak as e,E as r}from"./chunks/framework.Ct7YXsF8.js";const k=JSON.parse('{"title":"SESRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/SESRouter.md","filePath":"routers/SESRouter.md"}'),l={name:"routers/SESRouter.md"},c=Object.assign(l,{setup(d){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
