import{C as i,o as n,c as h,ak as e,E as d}from"./chunks/framework.DiNuf6zK.js";const k=JSON.parse('{"title":"APIGatewayRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/APIGatewayRouter.md","filePath":"routers/APIGatewayRouter.md"}'),r={name:"routers/APIGatewayRouter.md"},c=Object.assign(r,{setup(o){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
