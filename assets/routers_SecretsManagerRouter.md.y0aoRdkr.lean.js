import{C as n,o as r,c as h,ak as l,E as d,j as e,a as t}from"./chunks/framework.Ct7YXsF8.js";const g=JSON.parse('{"title":"SecretsManagerRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/SecretsManagerRouter.md","filePath":"routers/SecretsManagerRouter.md"}'),o={name:"routers/SecretsManagerRouter.md"},E=Object.assign(o,{setup(p){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
