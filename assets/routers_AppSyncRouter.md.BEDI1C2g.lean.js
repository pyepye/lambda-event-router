import{C as t,o as n,c as h,ak as i,E as r}from"./chunks/framework.DiNuf6zK.js";const o=JSON.parse('{"title":"AppSyncRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/AppSyncRouter.md","filePath":"routers/AppSyncRouter.md"}'),l={name:"routers/AppSyncRouter.md"},c=Object.assign(l,{setup(p){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
