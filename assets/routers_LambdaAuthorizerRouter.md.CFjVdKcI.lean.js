import{C as t,o as n,c as h,a6 as e,E as r}from"./chunks/framework.DlxdiH7Q.js";const k=JSON.parse('{"title":"LambdaAuthorizerRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/LambdaAuthorizerRouter.md","filePath":"routers/LambdaAuthorizerRouter.md"}'),o={name:"routers/LambdaAuthorizerRouter.md"},c=Object.assign(o,{setup(d){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
}`}];return(l,s)=>{const a=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=e("",105)),r(a,{files:i,id:"authorizer-example","default-file":"authorizer.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",4))])}}});export{k as __pageData,c as default};
