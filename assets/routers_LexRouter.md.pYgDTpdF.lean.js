import{C as n,o as l,c as h,ak as o,E as d,j as s,a as i}from"./chunks/framework.Ct7YXsF8.js";const E=JSON.parse('{"title":"LexRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/LexRouter.md","filePath":"routers/LexRouter.md"}'),r={name:"routers/LexRouter.md"},g=Object.assign(r,{setup(p){const t=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
}`}];return(k,e)=>{const a=n("CodeFileViewer");return l(),h("div",null,[e[0]||(e[0]=o("",67)),d(a,{files:t,id:"lex-example","default-file":"lex.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),e[1]||(e[1]=s("p",null,[i("The two "),s("code",null,"OrderPizza"),i(" routes match a different hook, so no turn reaches both and the order they register in makes no difference. "),s("code",null,"elicitIntent"),i(" filters on nothing, so it has to come last, and it catches any other intent Lex sends.")],-1)),e[2]||(e[2]=s("p",null,[s("code",null,"index.ts"),i(" hands the router to "),s("code",null,"LambdaRouter"),i(", which is what AWS invokes and what every router in the Lambda gets registered on. See "),s("a",{href:"/lambda-event-router/docs/routers"},"routers"),i(" for how the two levels of matching fit together.")],-1))])}}});export{E as __pageData,g as default};
