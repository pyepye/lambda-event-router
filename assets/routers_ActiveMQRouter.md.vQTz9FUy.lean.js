import{C as t,o as n,c as h,ak as e,E as d}from"./chunks/framework.DiNuf6zK.js";const k=JSON.parse('{"title":"ActiveMQRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/ActiveMQRouter.md","filePath":"routers/ActiveMQRouter.md"}'),r={name:"routers/ActiveMQRouter.md"},c=Object.assign(r,{setup(l){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type Order = z.infer<typeof OrderSchema>`}];return(o,s)=>{const i=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=e("",89)),d(i,{files:a,id:"activemq-example","default-file":"activemq.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",4))])}}});export{k as __pageData,c as default};
