import{C as t,o as n,c as h,ak as i,E as r}from"./chunks/framework.Ct7YXsF8.js";const o=JSON.parse('{"title":"KinesisRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/KinesisRouter.md","filePath":"routers/KinesisRouter.md"}'),l={name:"routers/KinesisRouter.md"},c=Object.assign(l,{setup(d){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type Status = z.infer<typeof StatusSchema>`}];return(p,s)=>{const a=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=i("",81)),r(a,{files:e,id:"kinesis-example","default-file":"kinesis.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=i("",3))])}}});export{o as __pageData,c as default};
