import{C as t,o as n,c as h,ak as e,E as r}from"./chunks/framework.DiNuf6zK.js";const k=JSON.parse('{"title":"FirehoseRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/FirehoseRouter.md","filePath":"routers/FirehoseRouter.md"}'),l={name:"routers/FirehoseRouter.md"},c=Object.assign(l,{setup(d){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
