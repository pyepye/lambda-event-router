import{C as n,o as h,c as r,ak as d,E as l,j as e,a as i}from"./chunks/framework.DiNuf6zK.js";const E=JSON.parse('{"title":"RabbitMQRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/RabbitMQRouter.md","filePath":"routers/RabbitMQRouter.md"}'),o={name:"routers/RabbitMQRouter.md"},g=Object.assign(o,{setup(p){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type Order = z.infer<typeof OrderSchema>`}];return(k,s)=>{const t=n("CodeFileViewer");return h(),r("div",null,[s[0]||(s[0]=d("",78)),l(t,{files:a,id:"rabbitmq-example","default-file":"rabbitmq.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("p",null,"The first two routes match a different queue, so no message can match both and the order they are registered in makes no difference to them.",-1)),s[2]||(s[2]=e("p",null,[i("The catch-all is the one route that cares where it sits, since empty filters match anything. Register it last and it takes what the other two turned down, which here is a plain text message on "),e("code",null,"orders"),i(" as much as anything from a third queue. Without it those throw, and a throw takes the rest of the batch with it.")],-1)),s[3]||(s[3]=e("p",null,[e("code",null,"index.ts"),i(" hands the router to "),e("code",null,"LambdaRouter"),i(", which is what AWS invokes and what every router in the Lambda gets registered on. See "),e("a",{href:"/docs/routers"},"routers"),i(" for how the two levels of matching fit together.")],-1))])}}});export{E as __pageData,g as default};
