import{C as t,o as n,c as h,a6 as i,E as r}from"./chunks/framework.DlxdiH7Q.js";const o=JSON.parse('{"title":"AppSyncRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/AppSyncRouter.md","filePath":"routers/AppSyncRouter.md"}'),l={name:"routers/AppSyncRouter.md"},c=Object.assign(l,{setup(p){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type CreateOrderArgs = z.infer<typeof CreateOrderSchema>`}];return(d,s)=>{const a=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=i("",102)),r(a,{files:e,id:"appsync-example","default-file":"appsync.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=i("",3))])}}});export{o as __pageData,c as default};
