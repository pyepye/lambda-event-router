import{C as t,o as n,c as h,a6 as e,E as r}from"./chunks/framework.DlxdiH7Q.js";const k=JSON.parse('{"title":"SESRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/SESRouter.md","filePath":"routers/SESRouter.md"}'),l={name:"routers/SESRouter.md"},c=Object.assign(l,{setup(d){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
}`}];return(p,s)=>{const a=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=e("",72)),r(a,{files:i,id:"ses-example","default-file":"ses.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",4))])}}});export{k as __pageData,c as default};
