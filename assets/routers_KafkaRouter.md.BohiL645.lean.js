import{C as t,o as n,c as h,a6 as a,E as r}from"./chunks/framework.DlxdiH7Q.js";const p=JSON.parse('{"title":"KafkaRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/KafkaRouter.md","filePath":"routers/KafkaRouter.md"}'),l={name:"routers/KafkaRouter.md"},c=Object.assign(l,{setup(d){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type StockAlert = z.infer<typeof StockAlertSchema>`}];return(o,s)=>{const i=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=a("",99)),r(i,{files:e,id:"kafka-example","default-file":"kafka.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=a("",3))])}}});export{p as __pageData,c as default};
