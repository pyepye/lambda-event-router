import{C as a,o as n,c as o,a6 as e,E as h}from"./chunks/framework.DlxdiH7Q.js";const k=JSON.parse('{"title":"WebSocketRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/WebSocketRouter.md","filePath":"routers/WebSocketRouter.md"}'),d={name:"routers/WebSocketRouter.md"},c=Object.assign(d,{setup(r){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type SendMessage = z.infer<typeof SendMessageSchema>`}];return(l,s)=>{const t=a("CodeFileViewer");return n(),o("div",null,[s[0]||(s[0]=e("",113)),h(t,{files:i,id:"websocket-example","default-file":"websocket.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",3))])}}});export{k as __pageData,c as default};
