...
export type Order = z.infer<typeof OrderSchema>`}];return(o,s)=>{const a=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=e("",86)),r(a,{files:i,id:"dynamodb-example","default-file":"dynamodb.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",3))])}}});export{k as __pageData,E as default};
