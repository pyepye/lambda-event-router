import{C as i,o as n,c as r,a6 as s,E as h}from"./chunks/framework.DlxdiH7Q.js";const k=JSON.parse('{"title":"Quick start","description":"","frontmatter":{},"headers":[],"relativePath":"docs/quick-start.md","filePath":"docs/quick-start.md"}'),o={name:"docs/quick-start.md"},c=Object.assign(o,{setup(l){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
}`}];return(d,e)=>{const t=i("CodeFileViewer");return n(),r("div",null,[e[0]||(e[0]=s(`<h1 id="quick-start" tabindex="-1">Quick start <a class="header-anchor" href="#quick-start" aria-label="Permalink to &quot;Quick start&quot;">​</a></h1><p>A Lambda handling an SQS queue takes two files. Once that works, adding a second event source to the same Lambda is one more router, which is the part worth being here for.</p><h2 id="install" tabindex="-1">Install <a class="header-anchor" href="#install" aria-label="Permalink to &quot;Install&quot;">​</a></h2><p>One package per event source your Lambda receives, plus <code>base</code>. <code>base</code> exports <code>LambdaRouter</code>, which every router plugs into. It is a peer dependency, so you install it yourself.</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">npm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @lambda-event-router/base</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @lambda-event-router/sqs</span></span></code></pre></div><p>A Lambda sitting behind an HTTP API and a queue adds one more:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">npm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @lambda-event-router/base</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @lambda-event-router/apigateway</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> @lambda-event-router/sqs</span></span></code></pre></div><p>If you are not sure which package you need, the <a href="/lambda-event-router/packages">packages page</a> lists every AWS event source we cover.</p><h2 id="your-first-lambda" tabindex="-1">Your first Lambda <a class="header-anchor" href="#your-first-lambda" aria-label="Permalink to &quot;Your first Lambda&quot;">​</a></h2><h3 id="_1-create-a-router-and-register-a-route" tabindex="-1">1. Create a router and register a route <a class="header-anchor" href="#_1-create-a-router-and-register-a-route" aria-label="Permalink to &quot;1. Create a router and register a route&quot;">​</a></h3><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { createSQSRouter } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@lambda-event-router/sqs&#39;</span></span>
