...
export type ListOrdersQuery = z.infer<typeof ListOrdersQuerySchema>`}];return(l,s)=>{const a=i("CodeFileViewer");return n(),d("div",null,[s[0]||(s[0]=e("",156)),h(a,{files:t,id:"lattice-example","default-file":"vpclattice.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",3))])}}});export{k as __pageData,c as default};
