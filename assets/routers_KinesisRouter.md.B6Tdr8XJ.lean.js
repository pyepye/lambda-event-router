import{C as t,o as n,c as h,a6 as i,E as r}from"./chunks/framework.DlxdiH7Q.js";const o=JSON.parse('{"title":"KinesisRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/KinesisRouter.md","filePath":"routers/KinesisRouter.md"}'),l={name:"routers/KinesisRouter.md"},c=Object.assign(l,{setup(d){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
