import{C as p,o as k,c as d,ak as i,E as h}from"./chunks/framework.Ct7YXsF8.js";const y=JSON.parse('{"title":"Handlers","description":"","frontmatter":{},"headers":[],"relativePath":"docs/handlers.md","filePath":"docs/handlers.md"}'),o={name:"docs/handlers.md"},u=Object.assign(o,{setup(E){const a=`import type { Handler } from 'aws-lambda'
...
export const OrderAttributesSchema = z.object({ dryRun: z.coerce.boolean().default(false) })`,t=`  const total = body.items.reduce((sum, { price, quantity }) => sum + price * quantity, 0)
  ...
  await notifications.send(body.customerEmail, 'order-confirmed', { total })`,r=[{path:"routes/processOrder.ts",code:`import { defineRoute } from '@lambda-event-router/sqs'
...
sqsRouter.route(processOrderRoute)`},{path:"index.ts",code:a}],l=[{path:"handlers/processOrder.ts",code:`import type { SQSMessageAttributes, SQSRequest, SQSResponse } from '@lambda-event-router/sqs'
...
})`},{path:"index.ts",code:a}];return(g,s)=>{const n=p("CodeFileViewer");return k(),d("div",null,[s[0]||(s[0]=i("",35)),h(n,{files:r,id:"inferred-handlers","default-file":"routes/processOrder.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=i("",5)),h(n,{files:l,id:"annotated-handlers","default-file":"handlers/processOrder.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[2]||(s[2]=i("",4))])}}});export{y as __pageData,u as default};
