import{C as i,o as n,c as r,ak as s,E as h}from"./chunks/framework.Ct7YXsF8.js";const k=JSON.parse('{"title":"Quick start","description":"","frontmatter":{},"headers":[],"relativePath":"docs/quick-start.md","filePath":"docs/quick-start.md"}'),o={name:"docs/quick-start.md"},c=Object.assign(o,{setup(l){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
