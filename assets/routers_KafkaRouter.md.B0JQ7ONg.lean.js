import{C as t,o as n,c as h,ak as a,E as r}from"./chunks/framework.Ct7YXsF8.js";const p=JSON.parse('{"title":"KafkaRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/KafkaRouter.md","filePath":"routers/KafkaRouter.md"}'),l={name:"routers/KafkaRouter.md"},c=Object.assign(l,{setup(d){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
