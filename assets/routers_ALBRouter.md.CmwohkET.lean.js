import{C as i,o as n,c as d,a6 as s,E as r}from"./chunks/framework.DlxdiH7Q.js";const k=JSON.parse('{"title":"ALBRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/ALBRouter.md","filePath":"routers/ALBRouter.md"}'),h={name:"routers/ALBRouter.md"},c=Object.assign(h,{setup(o){const t=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type ListOrdersQuery = z.infer<typeof ListOrdersQuerySchema>`}];return(l,e)=>{const a=i("CodeFileViewer");return n(),d("div",null,[e[0]||(e[0]=s("",154)),r(a,{files:t,id:"alb-example","default-file":"alb.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),e[1]||(e[1]=s("",4))])}}});export{k as __pageData,c as default};
