import{C as n,o as r,c as h,ak as d,E as o,j as e,a}from"./chunks/framework.Ct7YXsF8.js";const E=JSON.parse('{"title":"RabbitMQRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/RabbitMQRouter.md","filePath":"routers/RabbitMQRouter.md"}'),l={name:"routers/RabbitMQRouter.md"},g=Object.assign(l,{setup(p){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
