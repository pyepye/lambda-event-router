import{C as n,o as h,c as r,ak as l,E as d,j as i,a as e}from"./chunks/framework.Ct7YXsF8.js";const c=JSON.parse('{"title":"SQSRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/SQSRouter.md","filePath":"routers/SQSRouter.md"}'),p={name:"routers/SQSRouter.md"},g=Object.assign(p,{setup(k){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type Order = z.infer<typeof OrderSchema>`}];return(o,s)=>{const t=n("CodeFileViewer");return h(),r("div",null,[s[0]||(s[0]=l("",77)),d(t,{files:a,id:"sqs-example","default-file":"sqs.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=i("p",null,[e("Each route matches a different "),i("code",null,"Type"),e(" attribute, so no message can match both and the order you register them in makes no difference. Both accept the dead letter queue as well as the main one, so a redriven message lands on the same handler it would have the first time.")],-1)),s[2]||(s[2]=i("p",null,[i("code",null,"index.ts"),e(" hands the router to "),i("code",null,"LambdaRouter"),e(", which is what AWS invokes and what every router in the Lambda gets registered on. See "),i("a",{href:"/lambda-event-router/docs/routers"},"routers"),e(" for how the two levels of matching fit together.")],-1))])}}});export{c as __pageData,g as default};
