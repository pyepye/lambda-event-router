import{C as a,o as n,c as h,a6 as e,E as r}from"./chunks/framework.DlxdiH7Q.js";const k=JSON.parse('{"title":"AppSyncAuthorizerRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/AppSyncAuthorizerRouter.md","filePath":"routers/AppSyncAuthorizerRouter.md"}'),o={name:"routers/AppSyncAuthorizerRouter.md"},c=Object.assign(o,{setup(d){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
}`}];return(l,s)=>{const t=a("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=e("",85)),r(t,{files:i,id:"appsync-authorizer-example","default-file":"handlers/authorise.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",3))])}}});export{k as __pageData,c as default};
