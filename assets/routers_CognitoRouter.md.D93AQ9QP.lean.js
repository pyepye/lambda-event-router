import{C as n,o as r,c as o,ak as d,E as h,j as e,a as s}from"./chunks/framework.Ct7YXsF8.js";const g=JSON.parse('{"title":"CognitoRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/CognitoRouter.md","filePath":"routers/CognitoRouter.md"}'),l={name:"routers/CognitoRouter.md"},u=Object.assign(l,{setup(p){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type UserAttributes = z.infer<typeof UserAttributesSchema>`}];return(c,t)=>{const a=n("CodeFileViewer");return r(),o("div",null,[t[0]||(t[0]=d("",84)),h(a,{files:i,id:"cognito-example","default-file":"cognito.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),t[1]||(t[1]=e("p",null,[s("Each route filters on a different trigger, so no event can match two and the order they register in makes no difference. "),e("code",null,"provisionUser"),s(" reads a validated "),e("code",null,"userAttributes"),s(", so its schema is attached on the same route.")],-1)),t[2]||(t[2]=e("p",null,[e("code",null,"index.ts"),s(" hands the router to "),e("code",null,"LambdaRouter"),s(", which is what AWS invokes and what every router in the Lambda gets registered on. See "),e("a",{href:"/lambda-event-router/docs/routers"},"routers"),s(" for how the two levels of matching fit together.")],-1))])}}});export{g as __pageData,u as default};
