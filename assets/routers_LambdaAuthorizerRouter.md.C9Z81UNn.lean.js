import{C as t,o as n,c as h,ak as e,E as r}from"./chunks/framework.DiNuf6zK.js";const k=JSON.parse('{"title":"LambdaAuthorizerRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/LambdaAuthorizerRouter.md","filePath":"routers/LambdaAuthorizerRouter.md"}'),o={name:"routers/LambdaAuthorizerRouter.md"},c=Object.assign(o,{setup(d){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
