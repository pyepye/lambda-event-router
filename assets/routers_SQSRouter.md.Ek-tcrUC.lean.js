import{C as n,o as h,c as r,ak as l,E as p,j as i,a}from"./chunks/framework.DiNuf6zK.js";const c=JSON.parse('{"title":"SQSRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/SQSRouter.md","filePath":"routers/SQSRouter.md"}'),d={name:"routers/SQSRouter.md"},g=Object.assign(d,{setup(k){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
