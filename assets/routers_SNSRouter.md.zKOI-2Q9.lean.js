import{C as n,o as h,c as r,ak as l,E as d,j as i,a}from"./chunks/framework.Ct7YXsF8.js";const E=JSON.parse('{"title":"SNSRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/SNSRouter.md","filePath":"routers/SNSRouter.md"}'),p={name:"routers/SNSRouter.md"},g=Object.assign(p,{setup(k){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
