...
export type Order = z.infer<typeof OrderSchema>`}];return(l,s)=>{const i=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=e("",91)),r(i,{files:a,id:"activemq-example","default-file":"activemq.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",4))])}}});export{k as __pageData,c as default};
