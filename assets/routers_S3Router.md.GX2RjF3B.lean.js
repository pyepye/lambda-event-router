import{C as a,o as n,c as d,ak as s,E as h}from"./chunks/framework.Ct7YXsF8.js";const c=JSON.parse('{"title":"S3Router","description":"","frontmatter":{},"headers":[],"relativePath":"routers/S3Router.md","filePath":"routers/S3Router.md"}'),o={name:"routers/S3Router.md"},k=Object.assign(o,{setup(r){const t=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
