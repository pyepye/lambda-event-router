import{C as t,o as n,c as h,ak as a,E as l}from"./chunks/framework.DiNuf6zK.js";const o=JSON.parse('{"title":"KafkaRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/KafkaRouter.md","filePath":"routers/KafkaRouter.md"}'),r={name:"routers/KafkaRouter.md"},c=Object.assign(r,{setup(k){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type StockAlert = z.infer<typeof StockAlertSchema>`}];return(d,s)=>{const e=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=a("",86)),l(e,{files:i,id:"kafka-example","default-file":"kafka.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=a("",3))])}}});export{o as __pageData,c as default};
