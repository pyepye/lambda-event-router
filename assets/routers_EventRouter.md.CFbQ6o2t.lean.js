import{C as t,o as n,c as h,a6 as e,E as r}from"./chunks/framework.DlxdiH7Q.js";const k=JSON.parse('{"title":"EventRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/EventRouter.md","filePath":"routers/EventRouter.md"}'),l={name:"routers/EventRouter.md"},c=Object.assign(l,{setup(p){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export const handler: Handler = lambdaRouter.handler()`},{path:"events.ts",code:`import { createEventRouter, isObject } from '@lambda-event-router/base'
...
export type Purge = z.infer<typeof PurgeSchema>`}];return(d,s)=>{const a=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=e("",82)),r(a,{files:i,id:"event-example","default-file":"events.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",3))])}}});export{k as __pageData,c as default};
