import{C as n,o as h,c as r,ak as l,E as p,j as i,a}from"./chunks/framework.Ct7YXsF8.js";const E=JSON.parse('{"title":"Middleware","description":"","frontmatter":{},"headers":[],"relativePath":"docs/middleware.md","filePath":"docs/middleware.md"}'),d={name:"docs/middleware.md"},c=Object.assign(d,{setup(k){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
})`}];return(o,s)=>{const t=n("CodeFileViewer");return h(),r("div",null,[s[0]||(s[0]=l("",54)),p(t,{files:e,id:"middleware-example","default-file":"routers/api.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=i("p",null,[a("Each "),i("a",{href:"/lambda-event-router/packages"},"router page"),a(" lists its own middleware type alongside the options it accepts.")],-1))])}}});export{E as __pageData,c as default};
