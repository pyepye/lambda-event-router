import{C as n,o as h,c as l,a6 as r,E as d,j as i,a}from"./chunks/framework.DlxdiH7Q.js";const E=JSON.parse('{"title":"ConfigScheduledRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/ConfigScheduledRouter.md","filePath":"routers/ConfigScheduledRouter.md"}'),p={name:"routers/ConfigScheduledRouter.md"},g=Object.assign(p,{setup(k){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
