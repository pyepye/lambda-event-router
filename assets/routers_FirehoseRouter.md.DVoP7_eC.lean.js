...
export type AppEvent = z.infer<typeof AppEventSchema>`}];return(o,s)=>{const a=t("CodeFileViewer");return n(),h("div",null,[s[0]||(s[0]=e("",85)),r(a,{files:i,id:"firehose-example","default-file":"firehose.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",3))])}}});export{k as __pageData,c as default};
