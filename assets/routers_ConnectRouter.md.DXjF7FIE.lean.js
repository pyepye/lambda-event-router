import{C as n,o as h,c as o,ak as l,E as d,j as e,a as t}from"./chunks/framework.Ct7YXsF8.js";const E=JSON.parse('{"title":"ConnectRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/ConnectRouter.md","filePath":"routers/ConnectRouter.md"}'),r={name:"routers/ConnectRouter.md"},g=Object.assign(r,{setup(p){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export async function defaultContact({ contactData }: ConnectRequest): Promise<ConnectResponse> {
  ...
  return {}
}`}];return(c,s)=>{const i=n("CodeFileViewer");return h(),o("div",null,[s[0]||(s[0]=l("",67)),d(i,{files:a,id:"connect-example","default-file":"connect.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("p",null,[t("The first three routes match a distinct channel, so no contact reaches two of them and the order they register in makes no difference. "),e("code",null,"defaultContact"),t(" filters on nothing, so it has to come last, and it catches anything the others miss, such as an outbound voice call.")],-1)),s[2]||(s[2]=e("p",null,[e("code",null,"index.ts"),t(" hands the router to "),e("code",null,"LambdaRouter"),t(", which is what AWS invokes and what every router in the Lambda gets registered on. See "),e("a",{href:"/lambda-event-router/docs/routers"},"routers"),t(" for how the two levels of matching fit together.")],-1))])}}});export{E as __pageData,g as default};
