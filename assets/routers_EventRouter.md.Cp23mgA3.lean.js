import{C as t,o as n,c as h,ak as e,E as r}from"./chunks/framework.Ct7YXsF8.js";const k=JSON.parse('{"title":"EventRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/EventRouter.md","filePath":"routers/EventRouter.md"}'),l={name:"routers/EventRouter.md"},c=Object.assign(l,{setup(p){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
