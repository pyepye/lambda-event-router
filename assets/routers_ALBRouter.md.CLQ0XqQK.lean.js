import{C as i,o as n,c as d,ak as e,E as h}from"./chunks/framework.Ct7YXsF8.js";const k=JSON.parse('{"title":"ALBRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/ALBRouter.md","filePath":"routers/ALBRouter.md"}'),r={name:"routers/ALBRouter.md"},c=Object.assign(r,{setup(o){const a=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
export type ListOrdersQuery = z.infer<typeof ListOrdersQuerySchema>`}];return(l,s)=>{const t=i("CodeFileViewer");return n(),d("div",null,[s[0]||(s[0]=e("",147)),h(t,{files:a,id:"alb-example","default-file":"alb.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),s[1]||(s[1]=e("",4))])}}});export{k as __pageData,c as default};
