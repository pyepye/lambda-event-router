import{C as n,o as h,c as l,a6 as r,E as p,j as i,a}from"./chunks/framework.DlxdiH7Q.js";const E=JSON.parse('{"title":"Middleware","description":"","frontmatter":{},"headers":[],"relativePath":"docs/middleware.md","filePath":"docs/middleware.md"}'),d={name:"docs/middleware.md"},c=Object.assign(d,{setup(k){const e=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
