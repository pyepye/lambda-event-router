import{C as n,o as h,c as l,ak as o,E as r,j as e,a}from"./chunks/framework.Ct7YXsF8.js";const g=JSON.parse('{"title":"CloudWatchLogsRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/CloudWatchLogsRouter.md","filePath":"routers/CloudWatchLogsRouter.md"}'),d={name:"routers/CloudWatchLogsRouter.md"},E=Object.assign(d,{setup(p){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
