import{C as a,o as n,c as d,a6 as s,E as h}from"./chunks/framework.DlxdiH7Q.js";const c=JSON.parse('{"title":"S3Router","description":"","frontmatter":{},"headers":[],"relativePath":"routers/S3Router.md","filePath":"routers/S3Router.md"}'),o={name:"routers/S3Router.md"},k=Object.assign(o,{setup(r){const t=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
...
}`}];return(l,e)=>{const i=a("CodeFileViewer");return n(),d("div",null,[e[0]||(e[0]=s("",104)),h(i,{files:t,id:"s3-example","default-file":"s3.ts","line-numbers":"","collapse-toggle":"","fixed-height":""}),e[1]||(e[1]=s("",4))])}}});export{c as __pageData,k as default};
