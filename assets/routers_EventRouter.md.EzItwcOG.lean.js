import{C as t,o as n,c as h,ak as e,E as l}from"./chunks/framework.DiNuf6zK.js";const k=JSON.parse('{"title":"EventRouter","description":"","frontmatter":{},"headers":[],"relativePath":"routers/EventRouter.md","filePath":"routers/EventRouter.md"}'),r={name:"routers/EventRouter.md"},c=Object.assign(r,{setup(p){const i=[{path:"index.ts",code:`import type { Handler } from 'aws-lambda'
